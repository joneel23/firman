...
class Firman_Custom_Shortcodes {
	...
	public function create_shortcode_download_pdf( $atts ){
		...
		if ( empty( $pdf ) ) {
			...
			echo '<div class="download-pdf"><a href="' . $pdf_link . ' " target="_blank" rel="noopener"><span class="pdf-img"><img class="alignnone size-full wp-image-1342" src="/wp-content/uploads/2018/06/pdf_03_03_03.jpg" alt="" width="124" height="152" /></span> <span class="pdf-title">' . $pdf_title . '</span><span class="pdf-desc">Available in ' . $language . ' •</span><span class="pdf-size"> ' . $pdf_size . '</span>
	</a></div>';
		}
